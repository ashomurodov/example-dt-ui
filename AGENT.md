...
- **Auto-computed**: Display name + initials (from the **displayed** name — org name in a company context, the user's name otherwise), phone number, and avatar (absolute URL or `resourceUrl` + key) from the `user` object.
